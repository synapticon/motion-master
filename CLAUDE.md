...
main.cc  (composition root — the only place concrete types are instantiated; no `App` class yet)
 ...
 │     ├── unique_ptr<FieldbusDriver>   ← SoemFieldbusDriver | SpoeFieldbusDriver (planned); owns socketMutex_
