...
**Still open:** `hil/api` coverage of the new procedure, and the whole thing is **untested on hardware** — every test here runs against a fake driver, including the AL-state sequence and the retry policy.
