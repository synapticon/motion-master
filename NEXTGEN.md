...
**Open / next (deferred dump):** everything in the parked section above; the two-delivery-mode *last-N telemetry* path is also still a fast-follow (only the lossless mode shipped).
