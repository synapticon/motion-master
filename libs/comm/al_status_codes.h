...
struct AlStatusCode {
  uint16_t code;                 ///< AL Status Code value (ETG.1000.6 §6.4.1).
...
/// @brief Catalogue of AL Status Codes defined in ETG.1000.6 §6.4.1.
inline constexpr auto kAlStatusCodes = std::to_array<AlStatusCode>({
    ...
    {0x002E, "Cycle time too small", "The requested cycle time is smaller than the slave supports"},
