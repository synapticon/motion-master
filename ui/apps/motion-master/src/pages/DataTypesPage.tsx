...
export default function DataTypesPage() {
  ...
  return (
    <div>
      <PageHeader eyebrow="Meta" title="Object Data Types" />
        ...
        {query.isSuccess && (
          <>
            <p className="text-xs text-grey-600 mb-4 max-w-3xl">
              ...
              cross-references. The code is the 16-bit DataType field returned when reading an
              object's metadata from the dictionary.
            </p>
