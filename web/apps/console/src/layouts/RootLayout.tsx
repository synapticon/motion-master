  ...
  return (
    <div className="flex h-screen bg-grey-50 text-grey-900">
      ...
      <aside className="w-64 shrink-0 bg-ocean-dark flex flex-col border-r border-white/10">
        <div className="flex flex-col items-center border-b border-white/10 bg-linear-to-b from-grey-900 to-ocean-dark px-5 pt-5 pb-4">
          <img
            ...
            className={`h-14 w-14 rounded-lg transition-[filter] duration-500 ease-out ${online
          ...
          <p className="mt-0.5 text-xs font-display tracking-wide text-white/30">v6.0.0-alpha.84</p>
        </div>
        ...
        <nav className="flex-1 overflow-y-auto py-4 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/20 [&::-webkit-scrollbar-thumb:hover]:bg-white/40">
          ...
          {online && (
            <SidebarGroup label="Meta" defaultOpen={false}>
              ...
              <NavItem to="/meta/ic-haus-registers" label="iC-Haus Registers" />
              <NavItem to="/meta/kuebler-registers" label="Kübler Registers" />
